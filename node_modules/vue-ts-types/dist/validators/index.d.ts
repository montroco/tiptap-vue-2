export declare type Validator = (value: unknown) => string | undefined;
export declare type VuePropValidator = (value: unknown) => boolean;
/**
 ...
 */
export declare function vuePropValidator(userValidator?: Validator, ...typeValidators: Validator[]): VuePropValidator | undefined;
